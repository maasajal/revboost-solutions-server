...
import {
    ...
    premiumPlan,
    standardPlan,
} from "../../controllers/authorizationController/authorization.controller";
import {
    adminMiddleware,
    authMiddleware,
    basicPlanMiddleware,
...
router
  .route("/standard")
  .get(authMiddleware, standardPlanMiddleware, standardPlan);
router
  .route("/premium")
  .get(authMiddleware, premiumPlanMiddleware, premiumPlan);
